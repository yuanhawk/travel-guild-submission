...
_Note: AP2/Alipay mandates and the default wallet/merchant settlement surfaced
through these components are a mandate protocol with SIMULATED settlement —
not a real payment rail. The exception is the opt-in Circle USDC testnet
rail (`settlement_rail: "circle_usdc"`), which is a REAL on-chain settlement,
independent of AP2/Alipay — see `ucp-merchant/README.md`._
